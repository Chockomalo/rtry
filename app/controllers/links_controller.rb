class LinksController <ApplicationController
  ...
  def download
    ...
    @link.create_attachemt_links
    @link_attachments = @link.links
  end

  def download_attachment
    send_file(Rails.root.join("archivos",@link_attachment.attachment_id.to_s,"original",@link_attachment.attachment.archivo_file_name))
  end
